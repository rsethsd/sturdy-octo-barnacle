...
def display_screen():
    print (" " + matrix_input[0][0]+"   | "+matrix_input[0][1] + " | " + matrix_input[0][2]) 
    print ("----------------")
    print (" " + matrix_input[1][0]+"   | "+matrix_input[1][1] + " | " + matrix_input[1][2]) 
    print ("----------------")
    print (" " + matrix_input[2][0]+"   | "+matrix_input[2][1] + " | " + matrix_input[2][2]) 
    return True
...
def reset_board(): # This is a new function for resetting the board
    global list_1
    global list_2
    global list_3
    global matrix_input
        ...
        if (fill_value(assigneduser,player_input())):
            if (min_inputs  >= 3):
                ...
                if (var == True):
                    ...
                    display_screen()
                    print ("==============")
                    if ((raw_input("Do you want to play more:"))[0].lower() == 'y'):
                        print ("==============")
                        reset_board()
                        print ("==============")
                        continue
